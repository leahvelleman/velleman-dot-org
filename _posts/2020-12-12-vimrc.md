...
.language-bash div{ border-left: 2px solid var(--gold); background-color: var(--lightestgold);}
.language-vim div{ border-left: 2px solid var(--blue); background-color: var(--lightestblue);}
...
<span class="aside">This version of the post uses high-contrast colors
for accessibility. I actually use a low-contrast color
scheme called Solarized. Flip the switch to try both.</span>
...
This pane, with a white background and a bright cursor line, is my current Vim
...
If there are other panes with white backgrounds, they're part of the same Vim
...
Panes with dark backgrounds are outside my Vim session. I can only "reach" them
using Tmux commands.
...
This means that when I look at a screen region, its
reachability is the first thing I notice, before I
even focus my eyes to read a word of text. And when
I'm working in one region, I can tell what other
regions my actions might affect without looking
away, just by their color in my peripheral vision. 
...
using black and dark grey is great.

If you use a traditional light-background terminal color scheme that
...
color that's pale enough to use as a background, so much the better.

If you're going to use a color scheme that monkeys with the traditional color
locations, or a dark color scheme, you'll need to make some substitutions.

| Find                   | Replace with                           |
|------------------------|----------------------------------------|
| <code class="bluecode">0</code> or <code class="goldcode">colour0</code>       | A plain high-contrast foreground color |
| <code class="bluecode">15</code> or <code class="goldcode">colour15</code>     | A plain high-contrast background color |
| <code class="bluecode">8</code> or <code class="goldcode">colour8</code>       | A lower-contrast foreground color      |
| <code class="bluecode">7</code> or <code class="goldcode">colour7</code>       | A lower-contrast background color      |
| <code class="bluecode">11</code> or <code class="goldcode">colour11</code>     | A highlighted background color         |
| ---------------------- | ------------------------------------   |
