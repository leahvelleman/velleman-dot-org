...
.language-bash { border-left: 2px solid var(--gold); background-color: var(--lightestgold);}
.language-vim { border-left: 2px solid var(--blue); background-color: var(--lightestblue);}
